...
@export_custom(PROPERTY_HINT_NONE, "suffix:seconds") var healing_time: float = 0
@export var heal_ticks_array: Array[int] = []
@export_custom(PROPERTY_HINT_NONE, "suffix:seconds") var delay_time: float = 0
@export var heal_affected_stats: GlobalData.HealAffectedStats = GlobalData.HealAffectedStats.HEALTH_THEN_SHIELD
