...
@export_custom(PROPERTY_HINT_NONE, "suffix:seconds") var post_consumption_delay: float = 0.35 ## How long after a consumption must we wait before another consumption can occur.
