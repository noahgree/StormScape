...
@export var spawn_particles: bool = true ## Whether to spawn particles based on the name of this condition. If the name does not match any valid particle spawners, nothing will happen.
