...
@export var effect_source: NormalES = NormalES.new() ## The resource that defines what happens to the entity that consumes this consumable. Includes things like damage and conditions.
