...
@export var conditions: Array[Condition] ## The conditions to add to the weapon's effect source conditions.
@export var charge_conditions: Array[Condition] ## The conditions to add to the weapon's charge effect source conditions.
@export var aoe_conditions: Array[Condition] ## The conditions to add to the weapon's aoe effect source conditions.
