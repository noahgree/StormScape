...
@export var use_start_effect: Condition ## The condition to apply to the source entity at the start of use.
@export var post_use_effect: Condition ## The condition to apply to the source entity after use.
...
@export var charge_effect_source: EffectSource ## The resource that defines what happens to the entity that is hit by this weapon. Includes things like damage and conditions.
...
@export_subgroup("Entity Effects")
@export var chg_use_start_effect: Condition ## The condition to apply to the source entity at the start of a charge use.
@export var post_chg_use_effect: Condition ## The condition to apply to the source entity after charge use.
@export_subgroup("Usage FX")
