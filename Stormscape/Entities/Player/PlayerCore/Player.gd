...
func _add_player_debug_commands() -> void:
	...
	DebugConsole.add_command("condition", effect_src_receiver.apply_effect_by_id)
	DebugConsole.add_command("remove_condition_by_source", effect_src_receiver.remove_effect_by_id_and_source)
