...
func _add_player_debug_commands() -> void:
	...
	#DebugConsole.add_command("condition", esi_receiver.apply_effect_by_id)
	#DebugConsole.add_command("remove_condition_by_source", esi_receiver.remove_effect_by_id_and_source)
	#DebugConsole.add_command("remove_condition_by_id", esi_receiver.remove_all_effects_of_id)
	...
	DebugConsole.add_command("mod", sc.add_mod_from_scratch)
	DebugConsole.add_command("remove_mod", sc.remove_mod)
