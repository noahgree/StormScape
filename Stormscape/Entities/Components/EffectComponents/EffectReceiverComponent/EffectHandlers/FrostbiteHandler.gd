...
func handle_frostbite(frostbite_effect: FrostbiteEffect) -> void:
	...
	var frostbite_weakness: float = effect_receiver.affected_entity.sc.get_stat("frostbite_weakness")
	var frostbite_resistance: float = effect_receiver.affected_entity.sc.get_stat("frostbite_resistance")
