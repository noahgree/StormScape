...
static var esi_uid_counter: int = 0 ## The effect source instance uid counter.
...
## Generates a effect source instance uid and returns it.
static func generate_esi_uid()  -> int:
	esi_uid_counter += 1
	return esi_uid_counter
